...
import { Alert, Appearance, Clipboard, Pressable, StyleSheet, Switch, Text, View } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  userIdCard: { borderRadius: 16, borderWidth: 1, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 14 },
  userIdIcon: { width: 42, height: 42, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  userIdCopy: { flex: 1, gap: 6 },
  userIdLabel: { fontSize: 12, fontWeight: '600' },
  userIdChip: { flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8, alignSelf: 'flex-start' },
  userIdText: { fontSize: 14, fontWeight: '800', letterSpacing: 0.5 },
});