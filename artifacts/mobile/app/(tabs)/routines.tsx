...
export default function RoutinesScreen() {
  ...
  const { routines, exercises, addRoutine, updateRoutine, deleteRoutine, duplicateRoutine } = useGym();
  ...
  return <Screen>
    ...
    {editorVisible ? <View style={styles.sheetOverlay}><View style={styles.sheetContainer}><RoutineEditor routineId={editing} onClose={closeEditor} /></View></View> : null}
    {menuRoutine !== null ? <View style={styles.modalBackdrop}><View style={[styles.menuModal, { backgroundColor: colors.card }]}>
    ...
    {deleteConfirm !== null ? <View style={styles.modalBackdrop}><View style={[styles.menuModal, { backgroundColor: colors.card }]}>
...
function RoutineEditor({ routineId, onClose }: { routineId: string | null; onClose: () => void }) {
  ...
  return <ScrollView contentContainerStyle={[styles.editor, { backgroundColor: colors.background }]} keyboardShouldPersistTaps="handled">
    ...
    {nameError ? <View style={styles.modalBackdrop}><View style={[styles.menuModal, { backgroundColor: colors.card }]}>
    ...
    {exercisesError ? <View style={styles.modalBackdrop}><View style={[styles.menuModal, { backgroundColor: colors.card }]}>
